/*
  This entire file is borrowed from the excellent Tint and Shade Generator:
...
export function calculate(colorValue, shadeOrTint) {
...
// export function updateClipboardData() {
...
// export function makeTableRowColors(colors, displayType) {
//   var tableRow = "<tr>";
...
// export function createTintsAndShades(firstTime) {
